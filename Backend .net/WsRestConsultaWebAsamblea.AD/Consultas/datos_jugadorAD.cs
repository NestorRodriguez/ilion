    ...
    public class datos_jugadorAD
    {
        ...
        public List<datos_jugador> get_datos_jugador()
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                objad.rh = List_[17, 1].ToString();
                objad.pie_habil = List_[18, 1].ToString();
                objad.institucion = List_[19, 1].ToString();
                objad.grado = List_[20, 1].ToString();
                objad.eps = List_[21, 1].ToString();
                objad.prepagada = List_[22, 1].ToString();
                objad.sisben = List_[23, 1].ToString();
                objad.otra_clinica = List_[24, 1].ToString();
                objad.pregunta1 = List_[25, 1].ToString();
                objad.pregunta2 = List_[26, 1].ToString();
                objad.pregunta3 = List_[27, 1].ToString();
                objad.id_registro = List_[28, 1].ToString();
                list2.Add(objad);
            }
            return list2;
