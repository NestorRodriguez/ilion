...
class ilionService {
    ...
    getLogin(email, contraseña) {
        console.log(`${this.serverUrlLogin}?email=${email}&contraseña=${contraseña}`);
        return this.http.get(`${this.serverUrlLogin}?email=${email}&contraseña=${contraseña}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => console.log(JSON.stringify(data))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    setUsuario(data) {
    ...
    getUsuario() {
        return this.http.get(this.serverUrlUsuario).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => console.log(JSON.stringify(data))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    setDatos_jugador(data) {
        console.log(this.serverUrlInscripcion, data);
        return this.http.post(this.serverUrlInscripcion, data);
    }
    getDatos_jugador_id(id) {
        return this.http.get(`${this.serverUrlInscripcion}/${id}`);
    }
    getDatos_jugador() {
        return this.http.get(this.serverUrlInscripcion).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => console.log(JSON.stringify(data))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    putDatos_jugador(data) {
        console.log(data);
        return this.http.put(this.serverUrlInscripcion, data);
    }
    deleteDatos_jugador(id) {
